            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>codigoGrupo: </strong></span><br>
                        <span id="codigoGrupo_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>codigoEstado: </strong></span><br>
                        <span id="codigoEstado_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>cFOP: </strong></span><br>
                        <span id="cFOP_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>codigoCaracTrib: </strong></span><br>
                        <span id="codigoCaracTrib_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>finalidade: </strong></span><br>
                        <span id="finalidade_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>codRegra: </strong></span><br>
                        <span id="codRegra_regrafiscal"></span>
                    </div>
                </div>
                <hr>
                <div class="row mt-3">
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>codExcecao: </strong></span><br>
                        <span id="codExcecao_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>dtVigIni: </strong></span><br>
                        <span id="dtVigIni_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>dtVigFin: </strong></span><br>
                        <span id="dtVigFin_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>cFOPCaracTrib: </strong></span><br>
                        <span id="cFOPCaracTrib_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>cST: </strong></span><br>
                        <span id="cST_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>cSOSN: </strong></span><br>
                        <span id="cSOSN_regrafiscal"></span>
                    </div>
                </div>
                <hr>
                <div class="row mt-3">
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>aliqIcmsInterna: </strong></span><br>
                        <span id="aliqIcmsInterna_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>aliqIcmsInterestadual: </strong></span><br>
                        <span id="aliqIcmsInterestadual_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>reducaoBcIcms: </strong></span><br>
                        <span id="reducaoBcIcms_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>reducaoBcIcmsSt: </strong></span><br>
                        <span id="reducaoBcIcmsSt_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>redBcICMsInterestadual: </strong></span><br>
                        <span id="redBcICMsInterestadual_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>aliqIcmsSt: </strong></span><br>
                        <span id="aliqIcmsSt_regrafiscal"></span>
                    </div>
                </div>
                <hr>
                <div class="row mt-3">
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>iVA: </strong></span><br>
                        <span id="iVA_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>iVAAjust: </strong></span><br>
                        <span id="iVAAjust_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>fCP: </strong></span><br>
                        <span id="fCP_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>codBenef: </strong></span><br>
                        <span id="codBenef_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>pDifer: </strong></span><br>
                        <span id="pDifer_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>pIsencao: </strong></span><br>
                        <span id="pIsencao_regrafiscal"></span>
                    </div>
                </div>
                <hr>
                <div class="row mt-3">
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>antecipado: </strong></span><br>
                        <span id="antecipado_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>desonerado: </strong></span><br>
                        <span id="desonerado_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>pICMSDeson: </strong></span><br>
                        <span id="pICMSDeson_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>isento: </strong></span><br>
                        <span id="isento_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>tpCalcDifal: </strong></span><br>
                        <span id="tpCalcDifal_regrafiscal"></span>
                    </div>
                    <div class="col-md-5 border-end">
                        <span class="ts-subTitulo"><strong>ampLegal: </strong></span><br>
                        <span id="ampLegal_regrafiscal"></span>
                    </div>
                </div>
                <hr>
                <div class="row mt-3">
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>Protocolo: </strong></span><br>
                        <span id="Protocolo_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>Convenio: </strong></span><br>
                        <span id="Convenio_regrafiscal"></span>
                    </div>
                    <div class="col-md border-end">
                        <span class="ts-subTitulo"><strong>regraGeral: </strong></span><br>
                        <span id="regraGeral_regrafiscal"></span>
                    </div>
                </div>
            </div>
    ...
    $(document).on('click', 'button[data-bs-target="#modalRegraFiscal"]', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $dtVigIni_regrafiscal = data.dtVigIniFormatada;
                var vtitulo = $("#dtVigIni_regrafiscal");
                vtitulo.html($dtVigIni_regrafiscal);

                $dtVigFin_regrafiscal = data.dtVigFinFormatada;
