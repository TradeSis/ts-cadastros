...
if (isset($_GET['operacao'])) {
	...
	if ($operacao=="inserir") {
		...
		$grupoproduto = chamaAPI(null, '/cadastros/grupoproduto', json_encode($apiEntrada), 'PUT');
	...
	if ($operacao == "buscar") {
		...
		$grupoproduto = chamaAPI(null, '/cadastros/grupoproduto', json_encode($apiEntrada), 'GET');
